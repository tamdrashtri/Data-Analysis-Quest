...
##### 1 numerical variable: number of convictions
...
##### f. Describe the shape of the frequency distribution. Is it skewed or is it symmetric? Is it
unimodal or bimodal? Where is the mode in number of criminal convictions? Are there
outliers in the number of convictions?

##### g. Does the sample of boys used in this study represent a random sample of British boys? Why or why not?

#### 6. The following graph was drawn using a very popular spreadsheet program in an attempt to show the frequencies of observations in four hypothetical groups. Before reading further, estimate by eye the frequencies in each of the four groups.
